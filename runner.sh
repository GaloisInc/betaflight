# ========== vars
BIN_FILENAME=betaflight_4.2.0_MAIXBIT_norevision.bin #betaflight_4.2.0_MAIXBIT_469b42828.bin
...
make #cd betaflight-rubens_branch && 
...
if [ "$1" != "no" ]; then
	...
	cd obj && kflash -p $PORT $BIN_FILENAME #cd $KFLASH_PATH && python3 kflash.py -p $PORT $BIN_FILENAME
