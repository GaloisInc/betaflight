...
// #undef SERIAL_PORT_COUNT       1 // VCP

// #undef TARGET_IO_PORTA (0xffff & ~(BIT(14)|BIT(13)))
// #undef TARGET_IO_PORTB (0xffff & ~(BIT(2)))
// #undef TARGET_IO_PORTC (0xffff & ~(BIT(15)|BIT(14)|BIT(13)))
// #undef TARGET_IO_PORTD BIT(2)
