...
{
    validateAndFixConfig();
    print_my_msg("Validated and fixed config", __FUNCTION__, __FILE__, __LINE__);

    suspendRxPwmPpmSignal();
    print_my_msg("Suspended Rx Signals", __FUNCTION__, __FILE__, __LINE__);

    writeConfigToEEPROM();
    print_my_msg("Write Config to EEPROM complete", __FUNCTION__, __FILE__, __LINE__);

    resumeRxPwmPpmSignal();
    print_my_msg("Resumed Rx Signals", __FUNCTION__, __FILE__, __LINE__);
...
bool resetEEPROM(bool useCustomDefaults)
{
    ...
    writeUnmodifiedConfigToEEPROM();
    //print_my_msg("EEPROM structure valid", __FUNCTION__, __FILE__, __LINE__);
...
void ensureEEPROMStructureIsValid(void)
{
    ...
    print_my_msg("EEPROM structure NOT valid", __FUNCTION__, __FILE__, __LINE__);
