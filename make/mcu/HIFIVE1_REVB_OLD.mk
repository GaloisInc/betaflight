...
#STDPERIPH
STDPERIPH_DIR   = $(ROOT)/lib/main/HIFIVE1_REVB/freedom-metal
...
ARCH_FLAGS = -march=rv32imac -mabi=ilp32 -mcmodel=medlow -mseries=sifive-3-series
#
...
DEFAULT_LD_SCRIPT   = $(LINKER_DIR)/metal.default.lds

#as of 3/4, I have touched briefly so double check anything below this
#################

STARTUP_SRC         = entry.s
MCU_FLASH_SIZE     := 2048
DEVICE_FLAGS       += -DMAX_MPU_REGIONS=16
DEVICE_FLAGS       += -DHIFIVE1_REVB
